...
1. Push `index.html` to the root of a GitHub repo (e.g. `singh318683/clinic-dashboard`).
2. In Vercel, **Add New → Project → Import** that repo.
3. Framework preset: **Other** (framework-less static). Leave build command and output directory blank.
